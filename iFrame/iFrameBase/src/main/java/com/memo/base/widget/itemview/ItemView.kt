package com.memo.base.widget.itemview
 ...
 */
class ItemView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defAttr: Int = 0) : FrameLayout(context, attrs, defAttr) {
