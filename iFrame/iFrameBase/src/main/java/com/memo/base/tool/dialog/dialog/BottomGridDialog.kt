...
import com.memo.base.tool.dialog.listener.OnGridItemClickListener
 ...
 */
class BottomGridDialog constructor(
    context: Context,
    data: ArrayList<BottomGridDialog.GridItem> = arrayListOf()
) :
     ...
     */
    private var mData: ArrayList<BottomGridDialog.GridItem> =
            data
     ...
     * 设置数据源
     */
    fun setData(data: ArrayList<BottomGridDialog.GridItem>): BottomGridDialog {
     ...
     * 在末尾添加一个数据
     */
    fun addData(data: BottomGridDialog.GridItem): BottomGridDialog {
    ...
    fun addData(
        position: Int,
        data: BottomGridDialog.GridItem
    ): BottomGridDialog {
     ...
     * 设置点击监听
     */
    fun setOnItemClickListener(method: (position: Int, item: BottomGridDialog.GridItem) -> Unit): BottomGridDialog {
        mListener = object :
            ...
            override fun onItemClick(
                position: Int,
                item: BottomGridDialog.GridItem
            ) {
