...
object AnimHelper {
	 ...
	 */
	@JvmStatic
	fun createAlphaAnim(from: Float, to: Float, duration: Long, doMore: (animation: AlphaAnimation) -> Unit = {}): AlphaAnimation {
	 ...
	 */
	@JvmStatic
	fun createRotateAnim(duration: Long, repeatCount: Int = -1, doMore: (animation: RotateAnimation) -> Unit = {}): RotateAnimation {
	 ...
	 */
	fun createScaleAnim(from: Float, to: Float, duration: Long, doMore: (animation: ScaleAnimation) -> Unit = {}): ScaleAnimation {
	 ...
	 */
	@JvmStatic
	fun createVTranslateAnim(fromY: Float, toY: Float, duration: Long, doMore: (animation: TranslateAnimation) -> Unit = {}): Animation {
	 ...
	 */
	@JvmStatic
	fun createHTranslateAnim(fromX: Float, toX: Float, duration: Long, doMore: (animation: TranslateAnimation) -> Unit = {}): Animation {
		val anim = TranslateAnimation(
				Animation.RELATIVE_TO_SELF,
				fromX,
				Animation.RELATIVE_TO_SELF,
