package com.memo.base.widget.titleview
...
class TitleView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, def: Int = 0) : FrameLayout(context, attrs, def) {
